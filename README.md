...
<ul>
  ...
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-security-group/tree/main/examples">Examples</a>
    <ul>
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-security-group/tree/main/examples/add-rules-to-existing-sg">Example to add security group rules to an existing security group</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-security-group/tree/main/examples/add-rules-to-existing-sg-kube">Example to add security group rules to an existing security group (kube)</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-security-group/tree/main/examples/default">Default example</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-security-group/tree/main/examples/sg-target-example">Example to attach resources to security group</a>
